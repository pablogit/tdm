...
# -*- coding: utf-8 -*-
"""
Version  :  V2.3 adapted to modify labs files (CSV or XML) to be imported in Nicer Stat
Author   : 	Pablo Iriarte, CHUV/IUMSP 2016. pablo.irairte@chuv.ch, UNIGE 2017, 2018. pablo.irairte@unige.ch
...
at_version = "V2.3 ready for working with CSV and XML files as source and export (2018-05-08)"
...
if donames == 1:
	...
	labo_dafault = ""
	timestr = time.strftime("%Y%m%d-%H%M%S")
	# loop in PDFs cited in CSV or XML only, not il all PDFs in folder
	# myfilesnb = len(fnames)
